    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="mt-6 text-3xl font-bold text-gray-900">Välkommen tillbaka</h1>
          <p className="mt-2 text-gray-600">Logga in för att hantera dina recensioner</p>
        </div>
        ...
        <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
          ...
          <div className="mt-6 text-center text-sm text-gray-500">
            <p>Genom att logga in godkänner du våra</p>
            <p>
              <a href="#" className="text-primary hover:underline">användarvillkor</a>
              {' '}och{' '}
